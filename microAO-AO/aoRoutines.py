...
class ConventionalRoutine(Routine):
    ...
    def defaults():
        ...
        log_path = f"C:/dev/jingyu/testing/data/Conv-{ts}.h5"
        parameters = {
            "num_reps": 1,
            "NA": 1.1,
            "wavelength": 560e-9,
            "metric": 'fourier',
            "modes": (
                ConventionalParamsMode(5, np.linspace(-1, 1, 3)),
                ConventionalParamsMode(6, np.linspace(-1, 1, 3)),
                ConventionalParamsMode(7, np.linspace(-1, 1, 3)),
                ConventionalParamsMode(8, np.linspace(-1, 1, 3)),
                ConventionalParamsMode(9, np.linspace(-1, 1, 3)),
                ConventionalParamsMode(10, np.linspace(-1, 1, 3)),
                ConventionalParamsMode(11, np.linspace(-1, 1, 3)),
                ConventionalParamsMode(22, np.linspace(-1, 1, 3)),
            ),
            "log_path": log_path
        }
    ...
    def setup(self, sensorless_data):
        ...
        additional_data = {
            ...
            "mode_index": 0,
            "offset_index": 0,
            "corrections": sensorless_data['initial_modes'],
            "correction_stack": []
        }
...
class MLRoutine(Routine):
    ...
    def defaults():
        ts = datetime.strftime(datetime.now(), '%Y-%m-%d %H-%M-%S')
        log_path = f"C:/dev/jingyu/testing/data/ML1-{ts}.h5"
        parameters = {
            'n_reps': 5,
            'log_path': log_path
        }
    ...
    def setup(self, sensorless_data):
        ...
        self.model = tf.keras.models.load_model('C:/dev/jingyu/testing/microscope-aotools/models/cdd_L1L2_var_widefield_3layer_0_8_rmse_mode8_bias_10_ast_pnve_10_12_input_2_batch32s32_savedmodel.h5', compile=False)

        # Define the first correction to apply
        self.initial_modes = sensorless_data["initial_modes"].copy()
...
class MLRoutine2(Routine):
    ...
    def defaults():
        ts = datetime.strftime(datetime.now(), '%Y-%m-%d %H-%M-%S')
        log_path = f"C:/dev/jingyu/testing/data/ML2-{ts}.h5"
        parameters = {
            'n_reps': 1,
            'log_path': log_path
        }
    ...
    def setup(self, sensorless_data):
        ...
        self.model = tf.keras.models.load_model('C:/dev/jingyu/testing/microscope-aotools/models/cdd_L1L2_var_widefield_3layer_0_8_rmse_mode8_bias_10_8modes_pnve_10_12_input_16_batch32s32_savedmodel.h5', compile=False)
