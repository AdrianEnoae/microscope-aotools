...
class MLParametersDialog(wx.Dialog):
    def __init__(self, parent):
        ...
        self.n_reps = wx.TextCtrl(self, value="5")
        ...
        # Finalise layout
        sizer = wx.BoxSizer(wx.VERTICAL)
        sizer.Add(self.n_reps, 1, wx.EXPAND)
        sizer.Add(sizer_stdbuttons, 0, wx.ALL, 5)
        self.SetSizerAndFit(sizer)

    def _on_ok(self, event: wx.CommandEvent):
        n_reps = int(self.n_reps.GetValue())
        self._device.sensorless_params['n_reps'] = n_reps
...
routine_dialogs = {
    ...
    'ml': MLParametersDialog,
    'ml2': MLParametersDialog
}